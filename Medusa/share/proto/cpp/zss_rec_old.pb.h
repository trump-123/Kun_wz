...
class Balls4Rec PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ZSS::Protocol::Ball4Rec >*
      mutable_ball();
  private:
  const ::ZSS::Protocol::Ball4Rec& _internal_ball(int index) const;
  ::ZSS::Protocol::Ball4Rec* _internal_add_ball();
  public:
...
class Ball4Rec PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(Ball4Rec* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit Ball4Rec(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
// required int32 size = 1;
inline bool TeamRobotMsg::_internal_has_size() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TeamRobotMsg::_internal_size() const {
  return size_;
}
...
inline void TeamRobotMsg::_internal_set_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  size_ = value;
}
...
// optional int32 id = 1;
inline bool Robot4Rec::_internal_has_id() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Robot4Rec::_internal_id() const {
  return id_;
}
...
inline void Robot4Rec::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000008u;
  id_ = value;
}
...
inline const ::ZSS::Protocol::Ball4Rec& Balls4Rec::_internal_ball(int index) const {
...
inline ::ZSS::Protocol::Ball4Rec* Balls4Rec::_internal_add_ball() {
  return ball_.Add();
}
...
// required double posX = 1;
inline bool Ball4Rec::_internal_has_posx() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline double Ball4Rec::_internal_posx() const {
  return posx_;
}
...
inline void Ball4Rec::_internal_set_posx(double value) {
  _has_bits_[0] |= 0x00000001u;
  posx_ = value;
}
...
// required double posY = 2;
inline bool Ball4Rec::_internal_has_posy() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
...
inline double Ball4Rec::_internal_posy() const {
  return posy_;
}
...
inline void Ball4Rec::_internal_set_posy(double value) {
  _has_bits_[0] |= 0x00000002u;
  posy_ = value;
}
...
// optional bool valid = 3;
inline bool Ball4Rec::_internal_has_valid() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
...
inline bool Ball4Rec::_internal_valid() const {
  return valid_;
}
...
inline void Ball4Rec::_internal_set_valid(bool value) {
  _has_bits_[0] |= 0x00000004u;
  valid_ = value;
}
