...
CDefend_07_1::CDefend_07_1():_state(CDefend_07_1::NOTHING){
     ZSS::ZParamManager::instance()->loadParam(DEBUG_SWITCH, "DEBUG/Defend_07_1", true);
}
void CDefend_07_1::plan(const CVisionModule* pVision){
    if(pVision->getCycle() - _lastCycle > PARAM::Vision::FRAME_RATE*0.1)
    {_state = CDefend_07_1::NOTHING;}
...
//cout<<"0"<<endl;
    ...
    //cout<<"leader_Defend_07_1  :"<<n<<endl;
