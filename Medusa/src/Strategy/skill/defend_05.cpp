...
CDefend_05::CDefend_05():_state(CDefend_05::NOTHING){
     ZSS::ZParamManager::instance()->loadParam(DEBUG_SWITCH, "DEBUG/Defend_05", true);
}
void CDefend_05::plan(const CVisionModule* pVision){
    if(pVision->getCycle() - _lastCycle > PARAM::Vision::FRAME_RATE*0.1)
    {_state = CDefend_05::NOTHING;}
...
//cout<<"0"<<endl;
    ...
    CGeoPoint defend(p + Utils::Polar2Vector(700,Utils::Normalize(pos1.Dir())));
    auto dir = pos1.Dir();
