...
CDefend_07_0::CDefend_07_0():_state(CDefend_07_0::NOTHING){
     ZSS::ZParamManager::instance()->loadParam(DEBUG_SWITCH, "DEBUG/Defend_07_0", true);
}
void CDefend_07_0::plan(const CVisionModule* pVision){
    if(pVision->getCycle() - _lastCycle > PARAM::Vision::FRAME_RATE*0.1)
    {_state = CDefend_07_0::NOTHING;}
...
//cout<<"0"<<endl;
    ...
    //cout<<"leader_Defend_07_0  :"<<n<<endl;
    ...
    CGeoPoint defend(p + Utils::Polar2Vector(750,Utils::Normalize(pos1.Dir())+pi));
    auto dir = pos1.Dir();
...
/*
    ...
    //{
        ...
        newTask.player.pos = defend;
        newTask.player.angle = Utils::Normalize(pos1.Dir() + PARAM::Math::PI);
