...
CUniquekillskillm::CUniquekillskillm(){
    ZSS::ZParamManager::instance()->loadParam(DEBUG_SWITCH,"Debug/Touch",false);
}
void CUniquekillskillm::plan(const CVisionModule* pVision){
...
//    }
    ...
    targetPos = ball.Pos() + Utils::Polar2Vector(200,(OUR_GOAL - ball.Pos()).dir());
