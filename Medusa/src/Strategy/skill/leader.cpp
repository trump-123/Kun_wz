...
CLeader::CLeader():_state(CLeader::NOTHING){
     ZSS::ZParamManager::instance()->loadParam(DEBUG_SWITCH, "DEBUG/Leader", true);
}
void CLeader::plan(const CVisionModule* pVision){
    if(pVision->getCycle() - _lastCycle > PARAM::Vision::FRAME_RATE*0.1)
    {_state = CLeader::NOTHING;}
...
//        KickStatus::Instance()->setKick(vecNumber,8000);//踢球
        ...
        KickStatus::Instance()->setChipKick(vecNumber,8000);//挑球
        newTask.player.pos = defend;
