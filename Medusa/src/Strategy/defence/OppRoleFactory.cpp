...
/////>角色定义
////特定角色 NULL_ROLE
DEFINE_CLASS_EX_CPP(RNull)
//测试的oppRole
DEFINE_CLASS_EX_CPP(RTest)
DEFINE_CLASS_EX_CPP(RTest2)
DEFINE_CLASS_EX_CPP(RTest3)
DEFINE_CLASS_EX_CPP(RLeader)
DEFINE_CLASS_EX_CPP(RReceiver)
DEFINE_CLASS_EX_CPP(RSoldier)
DEFINE_CLASS_EX_CPP(RAttacker)
DEFINE_CLASS_EX_CPP(RGoalie)
DEFINE_CLASS_EX_CPP(RDefender)
DEFINE_CLASS_EX_CPP(RRusherFront)
DEFINE_CLASS_EX_CPP(RRusherBack)
