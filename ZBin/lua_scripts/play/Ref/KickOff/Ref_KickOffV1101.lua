...
local Defence_Pos = CGeoPoint:new_local(-1200,0)

local backPos = {
	ball.refAntiYPos(CGeoPoint:new_local(-1000,pw/4)),
	ball.refSyntYPos(CGeoPoint:new_local(-1000,pw/4))
}
...
["start"] = {
    ...
    Kicker   = task.goCmuRush(backPos[1] ,0,ACC,DSS_FLAG ),
    Center   = task.goCmuRush(backPos[2] ,0,ACC,DSS_FLAG ),
	Middle   = task.wback(2,1),
	Defender = task.wback(2,2),
	Goalie   = task.goalie(),
	match = "[L][AS][MD][BR][FKC]"
},
