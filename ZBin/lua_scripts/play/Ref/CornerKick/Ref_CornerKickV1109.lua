...
--6*4
local First  = ball.refSyntYPos(CGeoPoint:new_local(1650,900))
local Second = ball.refAntiYPos(CGeoPoint:new_local(pl/16,pw/4+290))
local Third  = ball.refSyntYPos(CGeoPoint:new_local(1650,1150))
local Fourth = ball.refSyntYPos(CGeoPoint:new_local(1650,1500))

local Real  = ball.refSyntYPos(CGeoPoint:new_local(1950,350))

local Real1 = ball.refAntiYPos(CGeoPoint:new_local(pl/8+500,pw/4-500))
...
local otherPos = ball.refAntiYPos(CGeoPoint:new_local(pl/2-1000,pew/2+400))

local ANTIPos  = ball.refSyntYPos(CGeoPoint:new_local(pl/8,pw/2-1000))
