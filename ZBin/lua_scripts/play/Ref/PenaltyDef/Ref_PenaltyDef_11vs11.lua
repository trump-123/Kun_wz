...
local DEF_POS8 = ball.refAntiYPos(CGeoPoint:new_local(DEFX, DEFY+param.playerRadius*9))
local DEF_POS9 = ball.refSyntYPos(CGeoPoint:new_local(DEFX, DEFY+param.playerRadius*9))
local DEF_POS10= ball.refSyntYPos(CGeoPoint:new_local(DEFX, DEFY+param.playerRadius*12))
