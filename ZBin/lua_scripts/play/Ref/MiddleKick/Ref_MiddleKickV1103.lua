...
local otherPos = {
	ball.refSyntYPos(CGeoPoint:new_local(param.pitchLength/2 - 1500,param.pitchWidth/2-1500)),
	ball.refAntiYPos(CGeoPoint:new_local(param.pitchLength/4 - 1000,param.pitchWidth/4-300)),
	ball.refAntiYPos(CGeoPoint:new_local(1000,param.pitchWidth/8)),
}
...
["start"] = {
	 ...
	 Fronter  = task.goCmuRush(otherPos[1],0,ACC,DSS_FLAG + flag.free_kick),	
	 Kicker   = task.goCmuRush(otherPos[2],0,ACC,DSS_FLAG + flag.free_kick),
	 Center   = task.goCmuRush(otherPos[3],0,ACC,DSS_FLAG + flag.free_kick),
