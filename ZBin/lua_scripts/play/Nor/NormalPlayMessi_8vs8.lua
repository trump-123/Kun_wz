...
["GetBall4"]={
	...
	Leader   = KICK_TASK(),
	Special  = task.wmarking("Third",_,getAttackerNum(3)),
	Middle   = task.wmarking("Zero",_,getAttackerNum(0)),
	Breaker  = task.wmarking("First",_,getAttackerNum(1)),
	Receiver = task.wmarking("Second",_,getAttackerNum(2)),
	Defender = task.wback(2,1),
...
["GetBall5"]={
	...
	Middle   = task.wmarking("Zero",_,getAttackerNum(0)),
	Breaker  = task.wmarking("First",_,getAttackerNum(1)),
	Receiver = task.wback(3,1),--task.wmarking("Second",_,getAttackerNum(2)),
	Defender = task.wback(3,2),--task.wmarking("Fourth",_,getAttackerNum(4)),
	Assister = task.wback(3,3),	
	Goalie   = task.goalie(goaliePassPos()),
	match    = "{L}[DRA][MBS]"
},
